...
The project UI contains page layout which have a side nav bar and different routes.

User Page --> The page shows the list of users in application and give facility to search by name.
...
All required dependencies will be install by it.
